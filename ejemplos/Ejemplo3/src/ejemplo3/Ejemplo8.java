...
public class Ejemplo8 {
    ...
    public static void main(String[] args) {
        ...
        // < 3 Reprobado
        // cualquier otrta nota sera fuera de rango
            ...
            if ((promedio >= 5) && (promedio < 7.5)) {
                ...
                if ((promedio >= 3) && (promedio < 5)) {
                    ...
                    if ((promedio <= 3) && (promedio >= 0)) {
                        // System.out.printf("Estudiante reprueba con un "
                               // + "promedio: %.2f\n", promedio);
                        mensaje = String.format("Estudiante reprueba con un "
                                + "promedio: %.2f\n", promedio);
                    } else {
                        if (promedio < 0) {
                            ...
                            // System.out.printf("La nota esta %.2f fuera de 
                            // rango"
                                 //    , promedio);
                            mensaje = String.format("La nota esta %.2f fuera "
                                    + "de rango", promedio);
                        }
                    }
                }
